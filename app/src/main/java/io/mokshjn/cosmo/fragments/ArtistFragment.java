...
public class ArtistFragment extends android.support.v4.app.Fragment implements ArtistAdapter.ClickListener {
    ...
    public void onConnected() {
        ...
        mMediaId = MediaIDHelper.MEDIA_ID_MUSICS_BY_ARTIST;
