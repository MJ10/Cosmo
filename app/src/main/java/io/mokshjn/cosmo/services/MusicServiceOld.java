...
public class MusicServiceOld extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener,
    ...
    private PendingIntent playbackAction(int actionNumber) {
        Intent playbackAction = new Intent(this, MusicServiceOld.class);
        switch (actionNumber) {
            case 0:
